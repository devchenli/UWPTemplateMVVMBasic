...
using UWPTemplateMVVMBasic.Activation;
using UWPTemplateMVVMBasic.BackgroundTasks;
using UWPTemplateMVVMBasic.Core.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace UWPTemplateMVVMBasic.Services
{
